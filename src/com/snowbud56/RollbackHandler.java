...
public class RollbackHandler {
    ...
    public void rollback(World world) {
        ...
        SpleefMinigame.getInstance().getServer().unloadWorld(world, false);
    ...
    public void rollback(String worldName) {
        String rootDirectory = SpleefMinigame.getInstance().getServer().getWorldContainer().getAbsolutePath();
